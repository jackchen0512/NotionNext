...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi,欢迎来到我的博客🎉,在这个小小的角落里,我将与您分享我的心情、见解和经验',
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://blog.0512.website', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
